...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "8517639341:AAG_68p9-VvYRG0wyP_vatqHQOvWNlmK1-M")
...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1003186424145"))
...
DB_NAME = os.environ.get("DATABASE_NAME", "Galaxyribot")

#force sub channel id, if you want enable force sub
FORCESUB_CHANNEL = int(os.environ.get("FORCESUB_CHANNEL", "-1002398041457"))
FORCESUB_CHANNEL2 = int(os.environ.get("FORCESUB_CHANNEL2", "-1003211230429"))
...
try:
    ADMINS=[7827448605]
    for x in (os.environ.get("ADMINS", "1683225887 7252834931 7813956229 5879656694 7887911003").split()):
        ADMINS.append(int(x))
except ValueError:
